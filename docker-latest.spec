...
%global commit6 ac031b5bf1cc92239461125f4c1ffb760522bbf2
%global shortcommit6 %(c=%{commit6}; echo ${c:0:7})

# docker-containerd
%global git7 https://github.com/docker/containerd
%global commit7 8517738ba4b82aff5662c97ca4627e7e4d03b531
...
Provides: %{name}-engine = %{epoch}:%{version}-%{release}
...
# install docker-runc
install -d %{buildroot}%{_libexecdir}/%{repo}
install -p -m 755 runc-%{commit6}/runc %{buildroot}%{_libexecdir}/%{repo}/%{repo}-runc-latest

#install docker-containerd
install -d %{buildroot}%{_libexecdir}/%{repo}
install -p -m 755 containerd-%{commit7}/bin/containerd %{buildroot}%{_libexecdir}/%{repo}/%{repo}-containerd-latest
...
%{_libexecdir}/%{repo}/%{repo}-containerd-latest
%{_libexecdir}/%{repo}/%{repo}-containerd-shim-latest
%{_libexecdir}/%{repo}/%{repo}-ctr-latest
...
%changelog
* Thu Nov 10 2016 Antonio Murdaca <runcom@fedoraproject.org> - 2:1.13-20.git6cd0bbe
...
- built docker-runc @projectatomic/runc-1.13 commit ac031b5
